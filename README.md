...
- To create and provision virtual machine with Vagrant - execute from command line :
    ...
    ==> default: Mounting shared folders...
        default: /vagrant => /Users/...tf-custom-plugin
    ...
    ...   
    ```
    After, there is an *installation phase for the set of tools (wget, Git, GOlang)*
    ...
    ```
    Where `77.162.119.95` is an external IP-address of the machine where you running the test, sure it can be different. And this output confirms that plugin had been successfully downloaded, compiled, installed and used during the *Terraform apply run*. 
- To completely destroy the VM and free up all your system resource (CPU, memory) execute from command line :
    ```
    vagrant destroy
    ```
